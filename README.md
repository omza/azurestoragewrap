...
```python
from azurestoragewrap.table import (
	StorageTableContext, 
	StorageTableModel, PartitionKey, RowKey,
	StorageTableQuery
	)
...
```python
# Import from azurestoragewrap
from azurestoragewrap.blob import StorageBlobModel, StorageBlobContext
...
```python
container = StorageBlobContext(**config)
...
* This project is licensed under the **MIT License** - *see this file for details:* [LICENSE](LICENSE.txt)